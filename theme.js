...
(function () {
    ...
    function createPalette() {
        document.querySelectorAll('[data-theme-palette]').forEach((container) => {
            ...
            container.innerHTML = `
                <button type="button" class="theme-dot theme-dot-blue" data-theme-choice="blue" aria-label="Tema azul" title="Azul"></button>
                <button type="button" class="theme-dot theme-dot-white" data-theme-choice="white" aria-label="Tema branco" title="Branco"></button>
                <button type="button" class="theme-dot theme-dot-green" data-theme-choice="green" aria-label="Tema verde" title="Verde"></button>`;
